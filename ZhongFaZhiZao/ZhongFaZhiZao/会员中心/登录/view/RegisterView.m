...
//    [self.vfCodeLbl sizeToFit];
    ...
    self.passWdLbl.font = [UIFont fontWithName:IconFont size:14.0];
...
//        make.left.equalTo(self.vfCodeTF.mas_left);
    ...
    [self.secondLine mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(self.vfCodeTF.mas_bottom);
...
//    }];
    ...
    [self.registerBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.view3.mas_bottom).offset(105*HEIGHT);
        make.centerX.equalTo(self.mas_centerX);
