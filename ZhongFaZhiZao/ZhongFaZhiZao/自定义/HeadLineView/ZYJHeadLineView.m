...
//    [self.currentView addSubview:self.currentLabel];
    ...
    self.currentLabel = [[UILabel alloc]initWithFrame:CGRectMake(5+CGRectGetMaxX(self.currentBtn.frame), (40-15)/2.0, screenWidth-8-(5+CGRectGetMaxX(self.currentBtn.frame)), 15)];
    self.currentLabel.text = model.title;
...
//    self.hidenBtn.layer.borderColor = [UIColor redColor].CGColor;
    ...
    //内容标题
    self.hidenLabel = [[UILabel alloc]initWithFrame:CGRectMake(5+CGRectGetMaxX(self.hidenBtn.frame), (40-15)/2.0, screenWidth-8-(5+CGRectGetMaxX(self.hidenBtn.frame)), 15)];
